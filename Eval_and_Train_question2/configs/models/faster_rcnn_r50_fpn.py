"""
Faster R-CNN model configuration using MMDetection 3.x.
...
Note:
This configuration follows MMDetection's declarative config style.
Certain pylint rules are disabled because config files are not
...
"""
Model definition: Faster R-CNN with ResNet-50 backbone and FPN.
"""
